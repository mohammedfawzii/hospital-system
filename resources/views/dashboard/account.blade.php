    ...
    <div class="card card-fluid">
        <div class="card-header">
            <div class="nav nav-tabs card-header-tabs">
                <h1 class="nav-item">
                    <a class="nav-link active show" data-toggle="tab" href="#tab1">Ambulance</a>
                </h1>
            </div>
        </div>
        <!-- .card-body -->
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table dataTable no-footer" aria-describedby="myTable_info"
                        ...
                        <thead>
                            <tr role="row">
                                <th>#</th>
                                <th class="align-middle sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                    colspan="1" aria-label=" Inventory : activate to sort column ascending"> Name </th>
                                <th class="align-middle sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                    colspan="1" aria-label=" Inventory : activate to sort column ascending"> Department
                                </th>
                                <th class="align-middle sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                    colspan="1" aria-label=" Variants : activate to sort column ascending"> Position
                                </th>
                                <th class="align-middle sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                    colspan="1" aria-label=" Prices : activate to sort column ascending"> Adriss </th>
                                <th class="align-middle sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                    colspan="1" aria-label=" Sales : activate to sort column ascending"> Phone </th>
                                <th style="width:100px; min-width:100px;" class="align-middle text-right sorting_disabled"
