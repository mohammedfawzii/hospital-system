              ...
              <div class="aside-menu overflow-hidden">
                  ...
                  <nav id="stacked-menu" class="stacked-menu">
                      ...
                      <ul class="menu">
                          <!-- .menu-item -->
                          <li class="">
                              <a href="" class="menu-link">Department's</a>
                          </li>
                          <li class="">
                              <a href="" class="menu-link">Clinics</a>
                          </li>
                          <li class="">
                              <a href="" class="menu-link">Patients</a>
                          </li>
                          <li class="">
                              <a href="" class="menu-link">Messages</a>
                          </li>
                          <li class=""><a href="" class="menu-link">Staff</a></li>
                          {{-- {{ 'dashboard/account' == request()->path() ? 'menu-item active' : 'menu-item' }} --}}
                          <li class="">
                              <a href="" class="menu-link">Accounts</a>
                          </li>
                          <li class="">
                              <a href="" class="menu-link">Pharmacy</a>
                          </li>
                          <li class="menu-item"><a href="" class="menu-link">Landing Page</a></li>
                      </ul><!-- /.menu -->
                  </nav><!-- /.stacked-menu -->
              </div><!-- /.aside-menu -->
              <!-- Skin changer -->
